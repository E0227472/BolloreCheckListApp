...
class ItemsList {
    ...
    mapItem(item, index) {
        ...
        const /** @type {?} */ value = isDefined(item.value) ? item.value : item;
        return {
            index: index,
            label: label,
            value: value,
...
class NgDropdownPanelComponent {
    ...
    _handleDropdownPosition() {
        ...
        const /** @type {?} */ selectEl = this._selectElementRef.nativeElement;
...
NgSelectComponent.decorators = [
    { type: Component, args: [{
                selector: 'ng-select',
                template: `<div (mousedown)="searchable ? open() : toggle()" [class.ng-has-value]="hasValue" class="ng-select-container">
